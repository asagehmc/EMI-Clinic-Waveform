"""
	Evaluates bloodPressureModel using several metrics
"""
...
def evaluate_BHS_Standard():
	"""
		Evaluates bloodPressureModel based on
		BHS Standard Metric
	"""
...
def evaluate_AAMI_Standard():
	"""
		Evaluate bloodPressureModel using AAMI Standard metric
	"""
...
def evaluate_BP_Classification():
	"""
		Evaluates bloodPressureModel for BP Classification
	"""
